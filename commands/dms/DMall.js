...
class DMallCommand extends commando.Command {
    ...
    async run(message, args){
      if (!message.member.hasPermission("MANAGE_SERVER")  && message.author.id !== "291221132256870400") return message.channel.send("Sorry, you don't have permissions to use this!");
